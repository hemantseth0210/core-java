...
public class StudentExample {
    public static void main(String[] args) {
        ...
        studentList.forEach(student -> System.out.println(student.name + " : " +student.marks + " : " + function.apply(student)));

        System.out.println("----------------------------------");
        Predicate<Student> predicate = student -> student.marks >= 60;
        studentList.forEach(student -> {
            if(predicate.test(student))
                System.out.println(student.name + " : " +student.marks + " : " + function.apply(student));
        });
